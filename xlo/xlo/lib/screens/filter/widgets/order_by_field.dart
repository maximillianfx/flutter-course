          ...
          children: <Widget>[
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  border: Border.all(
                    color: state.value == OrderBy.DATE ? Colors.blue : Colors.grey
                  ),
                  borderRadius: BorderRadius.all(Radius.circular(50)),
                  color: state.value == OrderBy.DATE ? Colors.blue : Colors.white
                ),
                child: Text(
                  'Data',
                  style: TextStyle(
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    border: Border.all(
                        color: state.value == OrderBy.PRICE ? Colors.blue : Colors.grey
                    ),
                    borderRadius: BorderRadius.all(Radius.circular(50)),
                    color: state.value == OrderBy.PRICE ? Colors.blue : Colors.white
                ),
                child: Text(
                  'Preço',
                  style: TextStyle(
