                          ...
                          builder: (_) {
                            return CustomTextField(
                              ...
                              suffix: listStore.isFormValid ? CustomIconButton(
                                radius: 32,
                                iconData: listStore.isFormValid ? Icons.add : null,
                                onTap: () {
                                  listStore.addTodo();
                                    ...
                                    builder: (_) {
                                      return ListTile(
                                        title: Text(
                                          ...
                                          style: TextStyle(
                                            decoration: listStore.todoList[index].done ? TextDecoration.lineThrough : null,
                                            color: listStore.todoList[index].done ? Colors.grey : Colors.black
                                          ),
                                        ),
